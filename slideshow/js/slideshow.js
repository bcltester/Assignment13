...
const createSlideshow = function () {
    ...
    return {
        ...
        setSpeed: function (newSpeed) {             // @@ is this how I should do this?
            speed = newSpeed;
            return this;
        },
        getSpeed: function () {                     // @@ is this how I should do this?
...
window.addEventListener('load', () => {
    ...
    $('speed').addEventListener('click', (e) => {               // @@ Need to review the solution
        e.preventDefault();
        slideshow.getSpeed();
        let spd = Number(prompt(`Enter new speed: (Will reflect the next time you press 'Resume')`));
        slideshow.setSpeed(spd);
    });
